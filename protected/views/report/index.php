...
<div class="page-header" style="padding-top:30px;">
		<h1>Form <small>Laporan.</small></h1>
</div><!-- page-header -->
<div class = "row">
	    ...
	    <?php $form=$this->beginWidget('CActiveForm', array(
	    	...
	    	<fieldset>
			    <div class="control-group">
				    ...
				    <div class="controls">
						<?php echo $form->dropDownList($model,'jenisLaporan', array('1'=>'Laporan Transaksi Jual','2'=>'Laporan Transaksi Beli','3'=>'Laporan Summary Penjualan','4'=>'Laporan Stock/Tanggal'), array('empty'=>'Pilih Jenis','class'=>'input-xlarge')); ?>
				    </div><!-- controls -->
			    ...
			    <div class="control-group">
				    ...
				    <div class="controls">
				    <?php $locationList=CHtml::listData(Location::model()->findAll(), 'id', 'location'); array_unshift($locationList,'All'); ?>
			    ...
			    <div class="control-group">
				    ...
				    <div class="controls">
				    <?php $supplierList=CHtml::listData(Supplier::model()->findAll(), 'id', 'company'); array_unshift($supplierList,'All'); ?>
