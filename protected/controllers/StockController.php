...
class StockController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','select','update'),
				'users'=>array('@'),
			),
	...
	public function actionSelect(){
		/*$row = Stock::model()->available()->findAll();
		foreach($row as $car){
			echo $car->NOMOBIL."<br/>";
		}*/
		...
		$cid="";
		if(!isset($_GET['cid'])&&isset($_GET['from'])){
			if($_GET['from']=='penjualan')
				$this->redirect(array('customer/select'));
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Stock']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->NOMOBIL));
		}
